...
**Ejercicio**: Crea una función que valide un formulario de registro usando diferentes estructuras de control. Debe verificar: nombre no vacío, email válido, edad entre 18-99, y contraseña segura. Usa try/catch para manejar errores y proporciona mensajes específicos para cada tipo de validación fallida.
